...
LBPHfaceRecognizer::LBPHfaceRecognizer(const vector<Mat> &imgs, int radius, int neighbors,
...
bool LBPHfaceRecognizer::Recognize(const Mat &face, double &confidence) const {
    Mat gray;
    int label;
